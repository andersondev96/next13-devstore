                ...
                <div className="mt-6 flex flex-col gap-6 border-t border-white/10 pt-6">
                    ...
                    <div className="flex items-start gap-4">
                        <div className="flex h-24 w-24 items-center justify-center rounded-lg bg-slate-800">
                            <Image
                                src="/camiseta_lumen_build_the_future.png"
                                width={80}
                                height={80}
                                quality={100}
                                alt="Camiseta Build the Future"
                            />
                        </div>

                        <div className="flex flex-1 flex-col">
                            <p className="font-medium text-white">Camiseta Build the Future</p>
                            <p className="text-sm text-slate-400">Preço: R$ 99,90</p>

                            <div className="mt-3 flex items-center gap-3">
                                <button className="rounded-full bg-slate-800 p-1.5 text-slate-400 transition-colors hover:bg-slate-700 hover:text-white disabled:cursor-not-allowed disabled:opacity-50">
                        ...
                        <div className="flex h-full flex-col items-end justify-between">
                            <span className="font-medium text-white">R$ 99,90</span>
                            <button
                                title="Remover item"
                    ...
                    <div className="flex items-start gap-4">
                        <div className="flex h-24 w-24 items-center justify-center rounded-lg bg-slate-800">
                            <Image
                                src="/moletom_lumen_while_alive.png"
                                width={80}
                                height={80}
                                quality={100}
                                alt="Moletom While Alive"
                            />
                        </div>

                        <div className="flex flex-1 flex-col">
                            <p className="font-medium text-white">Moletom While Alive</p>
                            <p className="text-sm text-slate-400">Preço: R$ 119,90</p>
                        ...
                        <div className="flex h-full flex-col items-end justify-between">
                            <span className="font-medium text-white">R$ 239,80</span>
                            <button
                                title="Remover item"
                                className="text-sm font-medium text-red-400 transition-colors hover:text-red-500"
                            >
